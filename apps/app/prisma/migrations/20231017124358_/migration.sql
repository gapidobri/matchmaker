...
CREATE TABLE "Queue" (
    ...
    CONSTRAINT "Queue_pkey" PRIMARY KEY ("teamId","gameId")
);
...
-- AddForeignKey
ALTER TABLE "Queue" ADD CONSTRAINT "Queue_gameId_fkey" FOREIGN KEY ("gameId") REFERENCES "Game"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
